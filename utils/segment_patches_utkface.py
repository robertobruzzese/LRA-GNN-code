...
for split in splits:
    ...
    for image_name in image_files:
        ...
        # Rimuove estensioni multiple come .jpg.chip.jpg
        image_base = image_name
        for ext in [".jpg", ".jpeg", ".png", ".chip"]:
            image_base = image_base.replace(ext, "")
        keypoints_path = os.path.join(points_dir, f"{image_base}.pts.chip.pts")
