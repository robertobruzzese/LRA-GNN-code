...
if __name__ == "__main__":
    ...
    ap.add_argument("--val_root", required=True, help="Es. embeddings_ablation_morph_lrc_no_dfe/val")
    ...
    if args.dataset.upper() == "CLAP2016":
        embedding_split = os.path.basename(args.val_root.strip("/")).lower()
    ...
    main(args.val_root, args.checkpoint, dataset=args.dataset, overwrite=args.overwrite, image_to_age=image_to_age)
