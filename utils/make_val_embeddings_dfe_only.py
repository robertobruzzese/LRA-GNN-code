...
if __name__ == "__main__":
    ...
    ap.add_argument("--val_root", required=True, help="Es. embeddings_ablation_morph_no_lrc_dfe/val")
    ...
    main(args.val_root, args.checkpoint, dataset=args.dataset, overwrite=args.overwrite)